...
// Thumb
loveYouGesture.addCurl(Finger.Thumb, FingerCurl.NoCurl, 1.00)
...
// Index
loveYouGesture.addCurl(Finger.Index, FingerCurl.NoCurl, 1.00);
loveYouGesture.addDirection(Finger.Index, FingerDirection.VerticalUp, 0.25);

// Pinky
loveYouGesture.addCurl(Finger.Pinky, FingerCurl.NoCurl, 1.00);
